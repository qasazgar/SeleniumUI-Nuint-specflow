...
namespace SpecFlowOmex.Features.LimitationsStockSymbol
{
    ...
    [NUnit.Framework.DescriptionAttribute("LimitationsCustomerStockSymbol")]
    public partial class LimitationsCustomerStockSymbolFeature
    {
...
#line 1 "LimitationsCustomerStockSymbol.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/LimitationsStockSymbol", "LimitationsCustomerStockSymbol", "\tBy Admin ", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("01) Customer limit for advertising the stock symbol")]
        [NUnit.Framework.CategoryAttribute("GoToUrlAndLoadPageAdmin")]
        [NUnit.Framework.CategoryAttribute("LogoutAdmin")]
        [NUnit.Framework.TestCaseAttribute("معامله با تعداد مشخص شده ،به دلیل محدودیت  در بازار اعمال نمی شود", "خساپا", "اعمال محدودیت مشتری در نماد خساپا", null)]
        public virtual void _01CustomerLimitForAdvertisingTheStockSymbol(string title, string symbolname, string massagefarsi, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01) Customer limit for advertising the stock symbol", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 9
 testRunner.When("Go to Menu limitations And Click Edit limitation insert Customer Name مجید یعقوبی" +
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("اعمال محدودیت مشتری در نماد خساپا", null)]
