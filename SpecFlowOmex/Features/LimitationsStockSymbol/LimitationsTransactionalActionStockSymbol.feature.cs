...
namespace SpecFlowOmex.Features.LimitationsStockSymbol
{
    ...
    [NUnit.Framework.DescriptionAttribute("LimitationsTransactionalActionStockSymbol")]
    public partial class LimitationsTransactionalActionStockSymbolFeature
    {
...
#line 1 "LimitationsTransactionalActionStockSymbol.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/LimitationsStockSymbol", "LimitationsTransactionalActionStockSymbol", "\tBy Admin ", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("01)Transactional Action limit for advertising the stock symbol")]
        [NUnit.Framework.CategoryAttribute("GoToUrlAndLoadPageAdmin")]
        [NUnit.Framework.CategoryAttribute("LogoutAdmin")]
        [NUnit.Framework.TestCaseAttribute("معامله با عمل معامله ،به دلیل جهت معامله در بازار اعمال نمی شود", "خساپا", "اعمال محدودیت عمل معامله در نماد خساپا", null)]
        public virtual void _01TransactionalActionLimitForAdvertisingTheStockSymbol(string title, string symbolname, string massagefarsi, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01)Transactional Action limit for advertising the stock symbol", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 9
 testRunner.When("Go to Menu limitations And Click Edit limitation insert Transactional Action ثبت " +
                        "سفارش", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("اعمال محدودیت عمل معامله در نماد خساپا", null)]
