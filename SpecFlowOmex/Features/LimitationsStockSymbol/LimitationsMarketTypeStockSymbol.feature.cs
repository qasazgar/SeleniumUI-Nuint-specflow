...
namespace SpecFlowOmex.Features.LimitationsStockSymbol
{
    ...
    [NUnit.Framework.DescriptionAttribute("LimitationsMarketTypeStockSymbol")]
    public partial class LimitationsMarketTypeStockSymbolFeature
    {
...
#line 1 "LimitationsMarketTypeStockSymbol.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/LimitationsStockSymbol", "LimitationsMarketTypeStockSymbol", "\tBy Admin ", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("01) Market Type limit for advertising the stock symbol")]
        [NUnit.Framework.CategoryAttribute("GoToUrlAndLoadPageAdmin")]
        [NUnit.Framework.CategoryAttribute("LogoutAdmin")]
        [NUnit.Framework.TestCaseAttribute("معامله با نوع بازار ،به دلیل محدودیت  در بازار اعمال نمی شود", "خساپا", "اعمال محدودیت نوع بازار  در نماد خساپا", null)]
        public virtual void _01MarketTypeLimitForAdvertisingTheStockSymbol(string title, string symbolname, string massagefarsi, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01) Market Type limit for advertising the stock symbol", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 9
 testRunner.When("Go to Menu limitations And Click Edit limitation insert Market Type بورس", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("اعمال محدودیت نوع بازار در نماد خساپا", null)]
