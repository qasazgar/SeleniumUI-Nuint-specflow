...
namespace SpecFlowOmex.Features.LimitationsStockSymbol
{
    ...
    [NUnit.Framework.DescriptionAttribute("LimitationsTimeValidityTypeStockSymbol")]
    public partial class LimitationsTimeValidityTypeStockSymbolFeature
    {
...
#line 1 "LimitationsTimeValidityTypeStockSymbol.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/LimitationsStockSymbol", "LimitationsTimeValidityTypeStockSymbol", "\tBy Admin ", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("01)Time Validity Type limit for advertising the stock symbol")]
        [NUnit.Framework.CategoryAttribute("GoToUrlAndLoadPageAdmin")]
        [NUnit.Framework.CategoryAttribute("LogoutAdmin")]
        [NUnit.Framework.TestCaseAttribute("معامله با تعداد مشخص شده ،به دلیل نوع اعتبار زمانی معامله در بازار اعمال نمی شود", "خساپا", "اعمال محدودیت نوع اعتبار زمانی معامله در نماد خساپا", null)]
        public virtual void _01TimeValidityTypeLimitForAdvertisingTheStockSymbol(string title, string symbolname, string massagefarsi, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01)Time Validity Type limit for advertising the stock symbol", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 9
 testRunner.When("Select the روز value in the  Time Validity Type search box", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("اعمال محدودیت نوع اعتبار زمانی معامله در نماد خساپا", null)]
