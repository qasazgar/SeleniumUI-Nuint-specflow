Feature: LimitationsIndustry
	Simple calculator for adding two numbers

@GoToUrlAndLoadPageAdmin@LogoutAdmin
Scenario:01) Date limit for advertising the stock symbol
	...
	When  Go to Menu limitations And Click Edit limitation insert Industy Name خودرو
	Then  the result should be time limit for advertising the stock symbol
	Examples:
	| Title |Symbolname| Massagefarsi |
	| معامله در صنعت به دلیل محدودیت  در بازار اعمال نمی شود | خساپا| اعمال محدودیت صنعت در نماد خساپا|
...
Scenario:  02)Buy stock symbol  with a minimum amount and a minimum number of day
	...
	Then the result should Buy shares of the symbol Message <Massagefarsi>
		Examples:
	 | Massagefarsi |
	| اعمال محدودیت صنعت در نماد خساپا|
