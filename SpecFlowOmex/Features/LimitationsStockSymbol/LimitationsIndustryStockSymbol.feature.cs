...
namespace SpecFlowOmex.Features.LimitationsStockSymbol
{
    ...
    [NUnit.Framework.DescriptionAttribute("LimitationsIndustry")]
    public partial class LimitationsIndustryFeature
    {
...
#line 1 "LimitationsIndustryStockSymbol.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/LimitationsStockSymbol", "LimitationsIndustry", "\tSimple calculator for adding two numbers", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("01) Date limit for advertising the stock symbol")]
        [NUnit.Framework.CategoryAttribute("GoToUrlAndLoadPageAdmin")]
        [NUnit.Framework.CategoryAttribute("LogoutAdmin")]
        [NUnit.Framework.TestCaseAttribute("معامله در صنعت به دلیل محدودیت  در بازار اعمال نمی شود", "خساپا", "اعمال محدودیت صنعت در نماد خساپا", null)]
        public virtual void _01DateLimitForAdvertisingTheStockSymbol(string title, string symbolname, string massagefarsi, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01) Date limit for advertising the stock symbol", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 9
 testRunner.When("Go to Menu limitations And Click Edit limitation insert Industy Name خودرو", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 10
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("اعمال محدودیت صنعت در نماد خساپا", null)]
