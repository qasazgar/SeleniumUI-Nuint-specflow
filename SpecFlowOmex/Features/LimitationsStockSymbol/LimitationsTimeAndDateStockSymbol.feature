Feature: LimitationsTimeAndDateStockSymbol
        By Admin 
...
Scenario:01) time limit for advertising the stock symbol
	...
	@GoToUrlAndLoadPageAdmin@LogoutAdmin
Scenario:02) Date limit for advertising the stock symbol
	Given LoginUser Admin With Username administrator And Password Administrator@IFS
	And   Go to Menu limitations 
	And   Edit Item  limitations
	When  The restriction should be applied from date 0 to date 3 on the stock symbol  
...
@GoToUrlAndLoadPageAdmin@LogoutAdmin
Scenario: 04)Delete limitations stock symbol
	Given LoginUser Admin With Username administrator And Password Administrator@IFS
	And   Go to Menu limitations   
