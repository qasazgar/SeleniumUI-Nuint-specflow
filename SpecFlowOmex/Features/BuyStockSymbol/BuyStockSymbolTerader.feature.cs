...
namespace SpecFlowOmex.Features.BuyStockSymbol
{
    ...
    [NUnit.Framework.DescriptionAttribute("BuyStockSymbolTrader")]
    public partial class BuyStockSymbolTraderFeature
    {
...
#line 1 "BuyStockSymbolTerader.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/BuyStockSymbol", "BuyStockSymbolTrader", "\t\t By Trader\r\n\t\t I Want Edit Buy  one Stock Symbol خساپا  \r\n\t\t so   Edit Buy stoc" +
                    "k symbol with amounts and numbers in different time periods", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Buy stock symbol  with a minimum amount and a minimum number of day")]
        ...
        public virtual void BuyStockSymbolWithAMinimumAmountAndAMinimumNumberOfDay(string price, string number, string plusprice, string plusnumber, string timerange, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Buy stock symbol  with a minimum amount and a minimum number of day", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line hidden
#line 13
 testRunner.When("Save stock symbol Buy order Trader information", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 14
